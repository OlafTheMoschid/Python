...
def test_show_user_all():
    x = get('http://127.0.0.1:8080/api/users')
    assert x.status_code == 200


def test_show_user_correct_id():
    x = get('http://127.0.0.1:8080/api/users/1')
    assert x.status_code == 200


def test_show_user_wrong_id():
    x = get('http://127.0.0.1:8080/api/users/10')
    assert x.status_code == 200


def test_show_user_string_id():
    x = get('http://127.0.0.1:8080/api/users/number')
    assert x.status_code == 200
...
def test_add_user_correct():
    ...
    x = post('http://127.0.0.1:8080/api/users', json=user)
    assert x.status_code == 200
